...
clustermethods = {'1. keep all saccades'; '2. keep first saccade'; '3. keep largest saccade (experimental!)'; '4. combine into 1 saccade (experimental!)'};
...
uilist = {...
    ...
    ...
    {'Style', 'text', 'string', 'Degrees visual angle per pixel (optional):'},...
    ...
    ...
    {'Style', 'text', 'string', 'Smooth eye velocity to suppress noise?'},...
